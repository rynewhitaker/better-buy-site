...
from betterbuysite.models import Product, Commodity, SmartPhoneVariant, SmartPhoneModel, OperatingSystem
from betterbuysite.models import Manufacturer, SmartCard


admin.site.site_header = "better-buy-site Administration"
...
class SmartPhoneAdmin(InvalidateProductCacheMixin, SearchProductIndexMixin, SortableAdminMixin, TranslatableAdmin, FrontendEditableAdminMixin,
    ...
    def render_text_index(self, instance):
        template = get_template(
            'search/indexes/betterbuysite/commodity_text.txt')
