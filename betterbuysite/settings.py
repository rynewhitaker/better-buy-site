"""
Django settings for betterbuysite project.
...
ADMINS = [("The Technical Boyz", 'john@example.com')]

# SECURITY WARNING: in production, inject the secret key through the environment
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY', 'llKNDz6OzRoWxmkGNE3CoIk9ugF9D9Cl30TWptooZfuPSZABdqFa4pbxE7n32Pda')
...
STATICFILES_FINDERS = [
    ...
    'betterbuysite.finders.FileSystemFinder',
    # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
    'betterbuysite.finders.AppDirectoriesFinder',
...
CMS_TEMPLATES = [
    ('betterbuysite/pages/default.html', _("Default Page")),
]
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            ('betterbuysite/catalog/manufacturer-filter.html',
             _("Manufacturer Filter")),
        ],
        # required to purchase real estate
        'ShopAddToCartPlugin': [
            (None, _("Default")),
            ('betterbuysite/catalog/commodity-add2cart.html',
...
SHOP_VALUE_ADDED_TAX = Decimal(9)
...
SHOP_PAYPAL = {
    ...
    'PURCHASE_DESCRIPTION': _("Thanks for purchasing at better-buy-site"),
}
...
SHOP_CASCADE_FORMS = {
    'CustomerForm': 'betterbuysite.forms.CustomerForm',
}
